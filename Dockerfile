...
ARG PYTHON_DEPS="atlassian-python-api pymongo requests walrus orjson pottery pypika psycogreen zstd brotli librabbitmq brotli zstd lzma eventlet gevent"
